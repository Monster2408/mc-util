...
public class MonsterKanaConverter {
    ...
    protected MonsterKanaConverter() {
    }
    ...
    static {
        ...
        //MLS特殊変換
        builder.put("dopperugennga-", "ドッペルゲンガー");
        builder.put("wa-rudobo-da-", "ワールドボーダー").put("worldborder", "ワールドボーダー");
        builder.put("appude-to", "アップデート");
        builder.put("test", "テスト");
        builder.put("player", "プレイヤー");
        builder.put("server", "サーバー").put("sa-ba-", "サーバー");
        builder.put("Kyou", "今日");
        builder.put("plugin", "プラグイン");
        builder.put("minecraft", "マイクラ");
        builder.put("discord", "ディスコード");
        builder.put("Konn", "こんにちは");
        builder.put("chat", "チャット");
        builder.put("Monster","モンスター");
        builder.put("system","システム");
        builder.put("CO2", "二酸化炭素");
        builder.put("H2O", "水");
        builder.put("craft", "クラフト");
        builder.put("google", "グーグル");
        builder.put("youtube", "YouTube");
        builder.put("twitter", "ツイッター");
        builder.put("instagram", "インスタグラム");
        builder.put("intellij", "Intellij");
        builder.put("spigot", "Spigot");
        builder.put("bukkit", "Bukkit");
        builder.put("paper", "Paper");
        builder.put("money", "Money");
        builder.put("java", "Java");
        builder.put("config", "コンフィグ");
        builder.put("html", "HTML");
        builder.put("mail", "メール");
        builder.put("microsoft", "マイクロソフト");
        builder.put("mcid", "MCID");
        builder.put("steam", "スチーム");
        builder.put("over", "オバー");
        builder.put("line", "LINE");
        builder.put("entity", "エンティティ");
        builder.put("target", "ターゲット");
        builder.put("zombie", "ゾンビ");
        builder.put("command", "コマンド");
        builder.put("dropbox", "DropBox");
        builder.put("skype", "スカイプ");
        builder.put("twitch", "Twitch");
        builder.put("python", "パイソン");
        builder.put("Shift", "シフト");
        builder.put("wiki", "ウィキペディア");
        builder.put("hello", "ハロー");
        builder.put("soyade", "そうやで");
        builder.put("po-syonn", "ポーション");
        builder.put("end", "エンド");
        builder.put("neza-suisyou", "ネザー水晶");
        builder.put("kuri-pa-", "クリーパー").put("creeper", "クリーパー");
        builder.put("supe-su", "スペース").put("space", "スペース");
        builder.put("skript", "Skript").put("Skript", "Skript").put("SKRIPT", "Skript");
        builder.put("Connected with MineChat", "MineChatというアプリから接続しています");
    ...
    private static boolean canStartFromSokuon(String romaji) {
        ...
        list[4] = "o";
        list[5] = "n";
        return !StringUtils.startsWithAny(romaji, list);
    }
    ...
    public static String conv(String romaji) {
        String[] list = romaji.split("§");
        String note = "";
        String First;
        char charFirst;
        boolean t = false;
        if (String.valueOf(romaji.charAt(0)).equalsIgnoreCase("§")) t = true;
        for (String text: list) {
            ...
            text = StringUtils.replaceEach(text, ROMAJI_LIST, HIRAGANA_LIST);
            text = First + text;
