package xyz.mlserver.util.serialization;

import org.jetbrains.annotations.Contract;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;
import xyz.mlserver.util.CollectionList;
import xyz.mlserver.util.ICollectionList;
import xyz.mlserver.util.Serializer;
import xyz.mlserver.util.Validate;
import xyz.mlserver.util.magic.Magic;
import xyz.mlserver.util.reflect.Ref;
import xyz.mlserver.util.reflect.RefClass;
import xyz.mlserver.util.reflect.RefConstructor;
import xyz.mlserver.util.reflect.RefField;
import xyz.mlserver.util.yaml.YamlArray;
import xyz.mlserver.util.yaml.YamlConfiguration;
import xyz.mlserver.util.yaml.YamlObject;
