...
import xyz.mlserver.mcutil.advancement.shared.SharedEnum;
 ...
 * All triggers must completed the requirements are explicitly specified using {@link xyz.mlserver.mcutil.advancement.Advancement#addRequirement(String...)}
 */
